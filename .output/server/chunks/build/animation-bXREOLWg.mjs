import { withCtx, createVNode, withDirectives, vModelCheckbox, openBlock, createBlock, useSSRContext } from 'vue';
...
const _sfc_main = {
  ...
  methods: {
    ...
    changeColor() {
      const faces = (undefined).querySelectorAll(".face");
      ...
      const middleFaces = (undefined).querySelectorAll(".middle-face");
      ...
      const innerFaces = (undefined).querySelectorAll(".inner-face");
      ...
      const innerMostFaces = (undefined).querySelectorAll(".innermost-face");
