...
import { g as genericComponent, a4 as __nuxt_component_1, p as propsFactory, B as useProxiedModel, f as useToggleScope, j as useRtl, e as provideTheme, $ as useDisplay, A as provideDefaults, H as clamp, m as makeThemeProps, a1 as makeDisplayProps, l as getCurrentInstance, h as convertToUnit, a3 as defer } from './server.mjs';
import { defineComponent, shallowRef, withCtx, createTextVNode, createVNode, toDisplayString, createBlock, openBlock, Fragment, renderList, ref, computed, watchEffect, toRef, watch, nextTick, onScopeDispose, mergeProps, Transition, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrInterpolate } from 'vue/server-renderer';
import { V as VApp, Y as VList, Z as VListItem, a0 as VListItemTitle, c as VBtn, a as VMain, a1 as useSsrBoot, _ as useLayoutItem, u as useRender, w as useBorder, h as useBackgroundColor, y as useElevation, g as useRounded, a2 as useRouter, a3 as toPhysical, $ as makeLayoutItemProps, a4 as makeVBtnProps, F as makeTagProps, n as makeComponentProps, m as makeRoundedProps, P as makeElevationProps, Q as makeBorderProps, t as VImg, k as VDefaultsProvider, a5 as VExpandTransition } from './VMain-4nSgokiH.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
      ...
      _push(ssrRenderComponent(VApp, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VAppBar, {
              color: "transparent",
              class: "position-absolute d-sm-none d-md-flex",
              flat: ""
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="d-md-flex d-none ga-4 mx-auto"${_scopeId2}><!--[-->`);
                  ssrRenderList(items, (item) => {
                  ...
                  return [
                    createVNode("div", { class: "d-md-flex d-none ga-4 mx-auto" }, [
                      (openBlock(), createBlock(Fragment, null, renderList(items, (item) => {
...
//# sourceMappingURL=portfolio-DR9oQ9Hu.mjs.map
