...
import { g as VList, h as VListItem, i as VListItemTitle, c as VImg, j as VExpandTransition } from './VList-xGdRHUsO.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              unref(isMounted) ? (openBlock(), createBlock(VNavigationDrawer, {
                key: 0,
                modelValue: drawer.value,
                "onUpdate:modelValue": ($event) => drawer.value = $event,
                color: "white",
